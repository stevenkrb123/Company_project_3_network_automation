...
router = Device(host='10.1.1.10', username='khoadang', password='password')
router.connect()
router.authenticate()
commands = ['khoadang','1234','enable', '1234', 'conf t', 'int loopback 0', 'ip address 1.1.1.1 255.255.255.255', 'exit',
