...
r1_dict = {'host': '10.1.1.10', 'username': 'khoadang', 'password': password, 'enable_password': password, 'loopback_ip': '1.1.1.1'}
r2_dict = {'host': '10.1.1.20', 'username': 'khoadang', 'password': password, 'enable_password': password, 'loopback_ip': '2.2.2.2'}
r3_dict = {'host': '10.1.1.30', 'username': 'khoadang', 'password': password, 'enable_password': password, 'loopback_ip': '3.3.3.3'}
